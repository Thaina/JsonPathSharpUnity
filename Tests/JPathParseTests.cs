...
namespace JsonPath.Tests
{
    ...
    public class JPathParseTests
    {
        ...
        public void BooleanQuery_TwoValues()
        {
            ...
            Assert.AreEqual(1,booleanExpression.Left);
            Assert.AreEqual(2,booleanExpression.Right);
        ...
        {
            Assert.Throws<Exception>(() => { new JPath("$ .Blah"); }, @"Unexpected character while parsing path:  ");
        }

        [Test]
        public void NoFieldNameAfterDot()
        {
            Assert.Throws<Exception>(() => { new JPath("$.Blah."); }, @"Unexpected end while parsing path.");
        }
        ...
        public void SingleScanWithRoot()
        {
            JPath path = new JPath("$..Blah");
            Assert.AreEqual(1, path.Filters.Count);
            Assert.IsAssignableFrom<FieldFilter>(path.Filters[0]);
            var filter  = path.Filters[0] as FieldFilter;
            Assert.IsTrue(filter.Scan);
            Assert.AreEqual("Blah",filter.Name);
        }
        ...
        public void ScanQuery()
        {
            ...
            var expression = (BooleanQueryExpression)((QueryFilter) path.Filters[1]).Expression;
        ...
        public void WildcardScanWithRoot()
        {
            ...
            var filter  = path.Filters[0] as FieldFilter;
            Assert.IsTrue(filter.Scan);
            Assert.AreEqual(null,filter.Name);
        }
        ...
        public void OnePropertyOneScan()
        {
            ...
            Assert.AreEqual(2, path.Filters.Count);
            Assert.AreEqual("Blah", ((FieldFilter)path.Filters[0]).Name);
            Assert.IsAssignableFrom<FieldFilter>(path.Filters[1]);
            var filter  = path.Filters[1] as FieldFilter;
            Assert.IsTrue(filter.Scan);
            Assert.AreEqual("Two",filter.Name);
        }
        ...
        public void SinglePropertyAndExistsQuery()
        {
            ...
            Assert.IsAssignableFrom<FieldFilter>(paths[0]);
            var filter  = paths[0] as FieldFilter;
            Assert.IsTrue(filter.Scan);
        ...
        public void SinglePropertyAndFilterWithWhitespace()
        {
            ...
            Assert.AreEqual("hi",expressions.Right);
        }
        ...
        public void SinglePropertyAndFilterWithEscapeQuote()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
            Assert.AreEqual(QueryOperator.Equals, expressions.Operator);
            Assert.AreEqual("h'i",expressions.Right);
        }
        ...
        public void SinglePropertyAndFilterWithRegexAndOptions()
        {
            ...
            Assert.AreEqual("/hi/i",expressions.Right);
        }
        ...
        public void SinglePropertyAndFilterWithRegex()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
            Assert.AreEqual(QueryOperator.RegexEquals, expressions.Operator);
            Assert.AreEqual("/^.*Sword.*$/",expressions.Right);
        }
        ...
        public void SinglePropertyAndFilterWithEscapedRegex()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
            Assert.AreEqual(QueryOperator.RegexEquals, expressions.Operator);
            Assert.AreEqual(@"/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g",expressions.Right);
        }

        [Test]
        public void SinglePropertyAndFilterWithOpenRegex()
        {
            Assert.Throws<Exception>(() => { new JPath(@"Blah[?(@.title =~ /[\"); }, "Path ended with an open regex.");
        }

        [Test]
        public void SinglePropertyAndFilterWithUnknownEscape()
        {
            Assert.Throws<Exception>(() => { new JPath(@"Blah[ ?( @.name=='h\i' ) ]"); }, @"Unknown escape character: \i");
        }
        ...
        public void SinglePropertyAndFilterWithFalse()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
            Assert.AreEqual(QueryOperator.Equals, expressions.Operator);
            Assert.AreEqual(false,expressions.Right);
        }
        ...
        public void SinglePropertyAndFilterWithTrue()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
            Assert.AreEqual(QueryOperator.Equals, expressions.Operator);
            Assert.AreEqual(true,expressions.Right);
        }
        ...
        public void SinglePropertyAndFilterWithNull()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
            Assert.AreEqual(QueryOperator.Equals, expressions.Operator);
            Assert.AreEqual(null,expressions.Right);
        }
        ...
        public void FilterWithInteger()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[0]).Expression;
            Assert.AreEqual(12,expressions.Right);
        }
        ...
        public void FilterWithFloat()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[0]).Expression;
            Assert.AreEqual(12.1d,expressions.Right);
        }
        ...
        public void BadOr1()
        {
            Assert.Throws<Exception>(() => new JPath("[?(@.name||)]"), "Unexpected character while parsing path query: )");
        }
        ...
        public void BaddOr4()
        {
            Assert.Throws<Exception>(() => new JPath("[?(@.name||"), "Path ended with open query.");
        }

        [Test]
        public void NoAtAfterOr()
        {
            Assert.Throws<Exception>(() => new JPath("[?(@.name||s"), "Unexpected character while parsing path query: s");
        }
        ...
        {
            Assert.Throws<Exception>(() => new JPath("[?(@.name||@."), @"Unexpected end while parsing path.");
        }
        ...
        public void FilterWithFloatExp()
        {
            ...
            BooleanQueryExpression expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[0]).Expression;
            Assert.AreEqual(5.56789e+0,expressions.Right);
        }
        ...
        public void MultiplePropertiesAndIndexers()
        {
            ...
            Assert.AreEqual("Blah", ((FieldFilter)path.Filters[0]).Name);
            Assert.AreEqual(0, ((ArrayIndexFilter)path.Filters[1]).Index);
            Assert.IsAssignableFrom<FieldFilter>(path.Filters[2]);
            var filter  = path.Filters[2] as FieldFilter;
            Assert.IsTrue(filter.Scan);
            Assert.AreEqual("Two",filter.Name);
        ...
        {
            Assert.Throws<Exception>(() => { new JPath("Blah[[0]].Two.Three[1].Four"); }, @"Unexpected character while parsing path indexer: [");
        }

        [Test]
        public void UnclosedIndexer()
        {
            Assert.Throws<Exception>(() => { new JPath("Blah[0"); }, @"Path ended with open indexer.");
        }
        ...
        {
            Assert.Throws<Exception>(() => { new JPath("[]"); }, "Array index expected.");
        }

        [Test]
        public void IndexerCloseInProperty()
        {
            Assert.Throws<Exception>(() => { new JPath("]"); }, "Unexpected character while parsing path: ]");
        }
        ...
        {
            Assert.Throws<Exception>(() => { new JPath("[1]Blah"); }, "Unexpected character following indexer: B");
        }
